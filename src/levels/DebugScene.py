...
class DebugScene(LevelScene):
    ...
    def __init__(self,switchscene):
        ...
        npcs = []
        testnpc = TalkNPC(Dialogue("Hey there! I'm Mr. Tomato.\rWelcome to the code playground.\rThis is where objects are tested!\rHow do you feel knowing our entire lives aren't real?\rArchie\0s: Uhh... bad, I guess?\0|\rOh. Well, that's pessimistic if you ask me."),1280,360,64,64,"tomato",emotion="smile")
        npcs.append(testnpc)
